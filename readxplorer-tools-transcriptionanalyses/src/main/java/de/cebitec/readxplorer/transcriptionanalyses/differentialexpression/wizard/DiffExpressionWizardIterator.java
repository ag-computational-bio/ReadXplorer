    ...
    public void actionPerformed( ActionEvent e ) {
        ...
        if( DialogDisplayer.getDefault().notify( wiz ) == WizardDescriptor.FINISH_OPTION ) {
            ...
            if( tool == DeAnalysisHandler.Tool.BaySeq ) {
                ...
                handler = new ExportOnlyAnalysisHandler( selectedTracks, genomeID, saveRCmdFile, featureTypes, startOffset, stopOffset, readClassParams, log );
                ...
                handler = new LinearRegressionAnalysisHandler( selectedTracks, groupA, groupB, genomeID, workingWithoutReplicates,
                                                               saveRCmdFile, featureTypes, startOffset, stopOffset, readClassParams, log );
            } else if( tool == DeAnalysisHandler.Tool.ExportContinuousCountTable ) {
                handler = new ExportOnlyContinuousAnalysisHandler( selectedTracks, genomeID, saveRCmdFile, featureTypes,
