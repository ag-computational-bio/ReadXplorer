 ...
 */
public class ParameterSetOperonDet extends ParametersFeatureTypesAndReadClasses
        implements ParameterSetI<ParameterSetOperonDet> {
     ...
     * Data storage for all parameters associated with an operon detection.
     * <p>
     * @param performOperonAnalysis     true, if the operon analysis should be
     *                                  carried out
     * @param minSpanningReads          minimum number of spanning reads between
     *                                  two neighboring
     *                                  features
