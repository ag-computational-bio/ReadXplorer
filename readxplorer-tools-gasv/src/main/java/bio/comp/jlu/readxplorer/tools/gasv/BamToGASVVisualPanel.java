...
public final class BamToGASVVisualPanel extends JobPanel {
    ...
    public BamToGASVVisualPanel( ParametersBamToGASV bamtoGASVParams ) {
        ...
        minMappingQualityField.getDocument().addDocumentListener( this.createDocumentListener() );
        maxPairLengthField.getDocument().addDocumentListener( this.createDocumentListener() );
        distPCTField.getDocument().addDocumentListener( this.createDocumentListener() );
        distSDField.getDocument().addDocumentListener( this.createDocumentListener() );
        distExactField.getDocument().addDocumentListener( this.createDocumentListener() );
        distFileField.getDocument().addDocumentListener( this.createDocumentListener() );
    }
     ...
     */
    private void updateComponentsForParams() {
        librarySeparatedBox.setSelected( params.isLibrarySeparated() );
        platformBox.setSelected( params.getPlatform() );
        writeConcPairsBox.setSelected( params.isWriteConcordantPairs() );
        writeLowQualBox.setSelected( params.isWriteLowQualityPairs() );
        minMappingQualityField.setText( String.valueOf( params.getMinMappingQuality() ) );
        maxPairLengthField.setText( String.valueOf( params.getMaxPairLength() ) );
        setIntegerWhenValid( distPCTField, params.getDistPCTValue() );
        setIntegerWhenValid( distSDField, params.getDistSDValue() );
        distExactField.setText( String.valueOf( params.getDistExactValue() ) );
        distFileField.setText( params.getDistFile() );

        switch( params.getFragmentBoundsMethod() ) {
            case SD:
        ...
        updateComponentsForSelection( params.getFragmentBoundsMethod() );

        switch( params.getSamValidationStringency() ) {
            case STRICT:
            ...
            case LENIENT:
                ...
                break;
            case SILENT: //fallthrough to default
            default:
     ...
     *                             distribution bounds.
     */
    private void updateComponentsForSelection( ParametersBamToGASV.FragmentBoundsMethod fragmentBoundsMethod ) {
        distPCTField.setEditable( fragmentBoundsMethod == ParametersBamToGASV.FragmentBoundsMethod.PCT );
        distSDField.setEditable( fragmentBoundsMethod == ParametersBamToGASV.FragmentBoundsMethod.SD );
        distExactField.setEditable( fragmentBoundsMethod == ParametersBamToGASV.FragmentBoundsMethod.EXACT );

        boolean isFile = fragmentBoundsMethod == ParametersBamToGASV.FragmentBoundsMethod.FILE;
        distChooseButton.setEnabled( isFile );
    }
    ...
    private void distPCTButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distPCTButtonActionPerformed
        if( distPCTButton.isSelected() ) {
            updateComponentsForSelection( ParametersBamToGASV.FragmentBoundsMethod.PCT );
            params.setFragmentBoundsMethod( ParametersBamToGASV.FragmentBoundsMethod.PCT );
        }
        isRequiredInfoSet();
    ...
    private void distSDButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distSDButtonActionPerformed
        if( distSDButton.isSelected() ) {
            updateComponentsForSelection( ParametersBamToGASV.FragmentBoundsMethod.SD );
            params.setFragmentBoundsMethod( ParametersBamToGASV.FragmentBoundsMethod.SD );
        }
        isRequiredInfoSet();
    ...
    private void distExactButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distExactButtonActionPerformed
        if( distExactButton.isSelected() ) {
            updateComponentsForSelection( ParametersBamToGASV.FragmentBoundsMethod.EXACT );
            params.setFragmentBoundsMethod( ParametersBamToGASV.FragmentBoundsMethod.EXACT );
        }
        isRequiredInfoSet();
    ...
    private void distFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distFileButtonActionPerformed
        if( distFileButton.isSelected() ) {
            updateComponentsForSelection( ParametersBamToGASV.FragmentBoundsMethod.FILE );
            params.setFragmentBoundsMethod( ParametersBamToGASV.FragmentBoundsMethod.FILE );
        }
        isRequiredInfoSet();
    ...
    private void valiSilentButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_valiSilentButtonActionPerformed
        if( valiSilentButton.isSelected() ) {
            params.setSamValidationStringency( ParametersBamToGASV.SamValidationStringency.SILENT );
        }
    ...
    private void valiLenientButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_valiLenientButtonActionPerformed
        if( valiLenientButton.isSelected() ) {
            params.setSamValidationStringency( ParametersBamToGASV.SamValidationStringency.LENIENT );
        }
    ...
    private void valiStrictButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_valiStrictButtonActionPerformed
        if( valiStrictButton.isSelected() ) {
            params.setSamValidationStringency( ParametersBamToGASV.SamValidationStringency.STRICT );
        }
...
//        if( !distExactField.getText().isEmpty() ) {
