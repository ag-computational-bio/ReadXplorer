 ...
 */
public class RPKMAnalysisArgsProcessor implements ArgsProcessor {

    private final static Logger LOG = Logger.getLogger( RPKMAnalysisArgsProcessor.class.getName() );
