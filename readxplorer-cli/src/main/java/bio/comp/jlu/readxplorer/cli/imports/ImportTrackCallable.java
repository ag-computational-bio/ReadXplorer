 ...
 */
public final class ImportTrackCallable implements Callable<PersistentTrack> {
    ...
    protected ImportTrackCallable( boolean verbosity ) {
    ...
    @Override
    public PersistentTrack call() throws CommandException {
...
//        }
    ...
    private void importRefGenome( final ReferenceJob rj, final PrintStream ps ) throws CommandException {
        ...
        ps.println(NbBundle.getMessage(ImportTrackCallable.class, "MSG_ImportThread.import.start.ref" ) + ":" );
        ...
        try {
            ...
            ps.println("\"" + rj.getName() + "\" " + NbBundle.getMessage(ImportTrackCallable.class, "MSG_ImportThread.import.parsed" ) );
            ...
            if( verbosity ) {
                ...
                String msg = "\"" + rj.getName() + "\" " + NbBundle.getMessage(ImportTrackCallable.class, "MSG_ImportThread.import.stored" );
...
//            ps.println( "\"" + rj.getName() + "\" " + NbBundle.getMessage( ImportThread.class, "MSG_ImportThread.import.failed" ) + "!" );
            CommandException ce = new CommandException( 1, "\"" + rj.getName() + "\" " + NbBundle.getMessage(ImportTrackCallable.class, "MSG_ImportThread.import.failed" ) );
                ce.initCause( ex );
            throw ce;
        }
...
//            ps.println( "\"" + rj.getName() + "\" " + NbBundle.getMessage( ImportThread.class, "MSG_ImportThread.import.outOfMemory" ) + "!" );
            CommandException ce = new CommandException( 1, "\"" + rj.getName() + "\" " + NbBundle.getMessage(ImportTrackCallable.class, "MSG_ImportThread.import.outOfMemory" ) );
                ce.initCause( ex );
            throw ce;
        }
