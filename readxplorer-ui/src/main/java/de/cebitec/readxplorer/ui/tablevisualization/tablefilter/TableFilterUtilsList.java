 ...
 */
public class TableFilterUtilsList<E extends ListTableModel> {
     ...
     */
    public TableFilterUtilsList( Class<E> classType ) {
     ...
     * the given model.
     * <p>
     * @param tableModel the table model to recreate with headers, but without
     *                   content.
     * <p>
