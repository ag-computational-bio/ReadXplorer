...
public enum ReadPairType {
    ...
    public static ReadPairType getReadPairType( int type ) {
        switch( type ) {
            case PERFECT_PAIR_INT:
                return PERFECT_PAIR;
            case DIST_LARGE_PAIR_INT:
                return DIST_LARGE_PAIR;
            case DIST_SMALL_PAIR_INT:
                return DIST_SMALL_PAIR;
            case ORIENT_WRONG_PAIR_INT:
                return ORIENT_WRONG_PAIR;
            case OR_DIST_LARGE_PAIR_INT:
                return OR_DIST_LARGE_PAIR;
            case OR_DIST_SMALL_PAIR_INT:
                return OR_DIST_SMALL_PAIR;
            case UNPAIRED_PAIR_INT:
                return UNPAIRED_PAIR;
            case PERFECT_UNQ_PAIR_INT:
                return PERFECT_UNQ_PAIR;
            case DIST_LARGE_UNQ_PAIR_INT:
                return DIST_LARGE_UNQ_PAIR;
            case DIST_SMALL_UNQ_PAIR_INT:
                return DIST_SMALL_UNQ_PAIR;
            case ORIENT_WRONG_UNQ_PAIR_INT:
                return ORIENT_WRONG_UNQ_PAIR;
            case OR_DIST_LARGE_UNQ_PAIR_INT:
                return OR_DIST_LARGE_UNQ_PAIR;
            case OR_DIST_SMALL_UNQ_PAIR_INT:
                return OR_DIST_SMALL_UNQ_PAIR;
            default:
                return UNPAIRED_PAIR;
        }
    }
