...
public class TssDetectionTest {
    ...
    HashMap<Integer, PersistentFeature> allRegionsInHash;
    ...
    public void testRunningTSSDetection() {
        ...
        PersistentReference persRef = new PersistentReference( 1, "B.Methanolicus", "no description", new Timestamp( 20014, 7, 21, 11, 12, 50, 0 ), persRefFile );
...
//        Assert.assertTrue("The TSS-Array is Empty", condition);
    ...
    private HashMap<Integer, List<Integer>> setUpFwdCDSs() {
        ...
        PersistentFeature feature1 = new PersistentFeature( 1, 1, "", "1", "test_1", "no", 666, 1000, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature2 = new PersistentFeature( 2, 1, "", "2", "test_2", "no", 1752, 3458, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature3 = new PersistentFeature( 4, 1, "", "3", "test_3", "no", 6000, 8333, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature4 = new PersistentFeature( 7, 1, "", "4", "test_4", "no", 12891, 13995, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature5 = new PersistentFeature( 9, 1, "", "5", "test_5", "no", 15002, 16245, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature6 = new PersistentFeature( 10, 1, "", "6", "test_6", "no", 16444, 17568, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature7 = new PersistentFeature( 14, 1, "", "7", "test_7", "no", 24000, 25354, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature8 = new PersistentFeature( 15, 1, "", "8", "test_8", "no", 25481, 25954, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature9 = new PersistentFeature( 17, 1, "", "9", "test_9", "no", 27034, 28548, true, FeatureType.CDS, "Test_1" );
        PersistentFeature feature10 = new PersistentFeature( 18, 1, "", "10", "test_10", "no", 29000, 29999, true, FeatureType.CDS, "Test_1" );
    ...
    private HashMap<Integer, List<Integer>> setUpRevCDSs() {
        ...
        PersistentFeature feature11 = new PersistentFeature( 3, 1, "", "11", "test_11", "no", 5000, 5530, false, FeatureType.CDS, "Test_1" );
        PersistentFeature feature12 = new PersistentFeature( 5, 1, "", "12", "test_12", "no", 9003, 9450, false, FeatureType.CDS, "Test_1" );
        PersistentFeature feature13 = new PersistentFeature( 6, 1, "", "13", "test_13", "no", 11000, 12000, false, FeatureType.CDS, "Test_1" );
        PersistentFeature feature14 = new PersistentFeature( 8, 1, "", "14", "test_14", "no", 14203, 14950, false, FeatureType.CDS, "Test_1" );
        PersistentFeature feature15 = new PersistentFeature( 11, 1, "", "15", "test_15", "no", 18222, 19750, false, FeatureType.CDS, "Test_1" );
        PersistentFeature feature16 = new PersistentFeature( 12, 1, "", "16", "test_16", "no", 21000, 22000, false, FeatureType.CDS, "Test_1" );
        PersistentFeature feature17 = new PersistentFeature( 13, 1, "", "17", "test_17", "no", 23000, 24000, false, FeatureType.CDS, "Test_1" );
        PersistentFeature feature18 = new PersistentFeature( 16, 1, "", "18", "test_18", "no", 27400, 28500, false, FeatureType.CDS, "Test_1" );
