...
/**
 * A table that translates nucletide codons to amino acids and aminoacids to codons.
 *
 * @author Lukas Jelonek <Lukas.Jelonek at computational.bio.uni-giessen.de>
 */
public interface TranslationTable {

    Character getTranslation(String codon);

    List<String> getCodons(Character c);
}
