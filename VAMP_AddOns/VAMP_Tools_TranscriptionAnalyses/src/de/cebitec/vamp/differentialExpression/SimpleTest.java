...
public class SimpleTest {
    ...
    public List<AnalysisHandler.Result> process(SimpleTestAnalysisData analysisData, int numberOfAnnotations, File saveFile) {
        ...
        List<AnalysisHandler.Result> results = new ArrayList<>();
        ...
        results.add(new AnalysisHandler.Result(rvec, colNames, rowNames, "Ordered by expression in group A"));
        ...
        results.add(new AnalysisHandler.Result(rvec, colNames, rowNames, "Ordered by expression in group B"));
    ...
    public void plotAB(File file) throws IllegalStateException {
        if (gnuR == null) {
    ...
    public void plotBA(File file) throws IllegalStateException {
        if (gnuR == null) {
            throw new IllegalStateException("Shutdown was already called!");
        }
        gnuR.setUpSvgOutput();
