 ...
 */
public class CoveredAnnosWizardPanel implements WizardDescriptor.Panel<WizardDescriptor> {
     ...
     */
    private CoveredAnnosVisualPanel component;
     ...
     * annotation detection.
     */
    public CoveredAnnosWizardPanel() {
    ...
    @Override
    public CoveredAnnosVisualPanel getComponent() {
        if (component == null) {
            component = new CoveredAnnosVisualPanel();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor wiz) {
        if (isValid()) {
            wiz.putProperty(CoveredAnnosWizardPanel.PROP_MIN_COVERED_PERCENT, this.component.getMinCoveredPercent());
            wiz.putProperty(CoveredAnnosWizardPanel.PROP_MIN_COVERAGE_COUNT, this.component.getMinCoverageCount());
        }
    }
}
