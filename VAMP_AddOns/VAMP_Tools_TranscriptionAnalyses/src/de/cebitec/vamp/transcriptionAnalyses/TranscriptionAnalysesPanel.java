 ...
 * @author -Rolf Hilker-
 * 
 * Creates a new transcription analyses panel, which contains the menu for different
 * transcription anlyses on the left side and a tabbed pane for the corresponding
 * result tables on the right side.
 */
public class TranscriptionAnalysesPanel extends javax.swing.JPanel implements DataVisualisationI {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(menuResultSplitPane, javax.swing.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE)
        );
...
//            this.transcAnalyzer.startAnalyses();
    ...
    private void startAnalyses() {
        if (this.detectGeneStarts && !this.doneGeneStarts) {
            ...
            int maxInitialReadCount = Integer.parseInt(this.geneStartField2.getText());
            int increaseReadCount2 = Integer.parseInt(this.geneStartField3.getText());
            this.analysisGeneStarts = new AnalysisGeneStart(this, this.trackViewer, increaseReadCount,
                    maxInitialReadCount, increaseReadCount2);
    ...
    public void showData(Object isDataAvailable) {
        ...
        if (isDataAvailable instanceof Boolean && ((Boolean) isDataAvailable) == true) {
            ...
            if (this.detectExpressedGenes && !this.doneExpressedGenes) {
                ...
                List<PersistantFeature> expressedGenes = this.analysisExpressedGenes.getResults();
