 ...
 * @author -Rolf Hilker-
 */
public class AnalysisFilterFeatures implements Observer, AnalysisI<List<FilteredFeature>> {
     ...
     */
    public AnalysisFilterFeatures(TrackConnector trackConnector, int minNumberReads, int maxNumberReads) {
    ...
    private void initDatastructures() {
        ...
        for (PersistantFeature feature : this.genomeFeatures) {
            this.featureReadCount.put(feature.getId(), new FilteredFeature(feature, trackConnector.getTrackID()));
        }
...
//        totalExonModelLength /= 1000;
    ...
    /**
     * @return the number of genome features of the analyzed reference genome
     */
