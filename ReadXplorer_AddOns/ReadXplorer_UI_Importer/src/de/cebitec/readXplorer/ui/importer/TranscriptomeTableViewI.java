...
public interface TranscriptomeTableViewI {
     ...
     */
    public void processCsvInput(List<List<?>> tableData, List<List<?>> tableData2, TableType type, PersistantReference reference);
     ...
     * 
     * @param reference PersistantReference
     * @param model DefaultTableModel contains all table entries.
     * @param secondSheetMap Map<String, String> contains all entries of the
