 ...
 */
@ConvertAsProperties(dtd = "-//de.cebitec.readXplorer.tools.snp454//SNP_Detection454//EN",
autostore = false)
@TopComponent.Description(preferredID = "SNP_Detection454TopComponent",
iconBase = "de/cebitec/readXplorer/tools/snp454/snpDetection.png",
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "output", openAtStartup = false)
@ActionID(category = "Window", id = "de.cebitec.readXplorer.tools.snp454.SNP_Detection454TopComponent")
...
public final class SNP_Detection454TopComponent extends TopComponentExtended {
    ...
    private de.cebitec.readXplorer.tools.snp454.SNP_Detection454SetupPanel snpDetection454SetupPanelTemplate;
    private de.cebitec.readXplorer.tools.snp454.SNP_Detection454ResultPanel snpDetection454ResultPanelTemplate;
