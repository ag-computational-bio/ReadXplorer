...
import de.cebitec.readXplorer.transcriptomeAnalyses.wizard.TranscriptomeAnalysisWizardIterator;
...
@ActionID(
        category = "Tools",
        id = "de.cebitec.readXplorer.transcriptomeAnalyses.StartTranscriptomeAnalysesAction")
@ActionRegistration(
