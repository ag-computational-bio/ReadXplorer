 ...
 */
@ConvertAsProperties(
    dtd = "-//de.cebitec.readXplorer.transcriptomeAnalyses//TranscriptomeAnalyses//EN",
autostore = false)
@TopComponent.Description(
    preferredID = "TranscriptomeAnalysesTopComponent",
iconBase = "de/cebitec/readXplorer/transcriptomeAnalyses/transcriptomeAnalyses.png",
...
@TopComponent.OpenActionRegistration(
    displayName = "#CTL_TranscriptomeAnalysesAction",
preferredID = "TranscriptomeAnalysesTopComponent")
@Messages({
    "CTL_TranscriptomeAnalysesAction=TranscriptionAnalyses",
    "CTL_TranscriptomeAnalysesTopComponent=TranscriptomeAnalyses Window",
    "HINT_TranscriptomeAnalysesTopComponent=This is a TranscriptomeAnalyses window"
})
