...
/**
 * Top component which displays the details of the currently selected reference
 * feature.
 */
...
public final class ReferenceFeatureTopComp extends TopComponentExtended
    ...
    private static final Logger LOG = LoggerFactory.getLogger( ReferenceFeatureTopComp.class.getName() );
...
//        this.setIcon(ImageUtilities.loadImage(ICON_PATH, true));
    ...
    /**
     * Transforms the given node list into a vector of persistent features. The
     * vector only contains elements, if the nodes are instances of
