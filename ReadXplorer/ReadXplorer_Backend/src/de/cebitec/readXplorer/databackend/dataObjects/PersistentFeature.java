 ...
 */
public class PersistentFeature extends Node implements PersistentFeatureI, Comparable<PersistentFeature> {
...
//    }
    ...
    /**
     * Compares two PersistentFeature based on their start position. '0' is returned for
