...
public class ColorProperties {
    ...
    /** 0.3f = General minimum saturation and brightness for colored elements in ReadXplorer. */
    public static final float MIN_SATURATION_AND_BRIGTHNESS = 0.4f;
    /** 0.9f = General maximum saturation and brightness for colored elements in ReadXplorer. */
