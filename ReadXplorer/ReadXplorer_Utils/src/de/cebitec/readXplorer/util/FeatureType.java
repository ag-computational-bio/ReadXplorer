...
/**
 * Enumeration for all different features types used in readXplorer. This does not only
...
public enum FeatureType {
    ...
    COMMON_COVERAGE(FeatureType.COMPLETE_COV_INT, FeatureType.COMPLETE_COV_STRING),
