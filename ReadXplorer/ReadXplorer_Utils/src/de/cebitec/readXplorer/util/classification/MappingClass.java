...
public enum MappingClass implements Classification {
     ...
     * without differences to the reference. Perfect Match classification =
     * MappingClass for all mappings of a read without differences to
     * the reference. Perfect Match classification = MappingClass for all
     * mappings of a read without differences to the reference.
     */
 ...
 to the reference). Other Common Match mappings are allowed to exist for
    ...
    /**
     * Single Common Match classification = MappingClass for read mappings
 which are a single Common Match mapping. Meaning, this is the single
     * worst mapping of the read and at least one Perfect or Best Match mapping
     * has to exist for the read.
     */
    SINGLE_COMMON_MATCH(MappingClass.SINGLE_COMMON_MATCH_BYTE, MappingClass.SINGLE_COMMON_MATCH_STRING);
    ...
    private static final byte SINGLE_COMMON_MATCH_BYTE = 6;
    ...
    private static final String SINGLE_COMMON_MATCH_STRING = "Single Common Match";
    ...
    public static MappingClass getFeatureType(Byte type) {
        ...
        switch (type) { 
            ...
            case SINGLE_COMMON_MATCH_BYTE:   return SINGLE_COMMON_MATCH;
