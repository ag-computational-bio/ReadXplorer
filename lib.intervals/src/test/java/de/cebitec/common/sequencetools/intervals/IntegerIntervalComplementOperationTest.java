...
public class IntegerIntervalComplementOperationTest {
    ...
    public IntegerIntervalComplementOperationTest(Interval<Integer> fst, Interval<Integer> snd, Interval<Integer> result) {
        this.fst = fst;
        this.snd = snd;
        this.result = result;
    }
