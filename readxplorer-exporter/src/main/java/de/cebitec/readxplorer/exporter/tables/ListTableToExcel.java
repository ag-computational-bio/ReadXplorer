 ...
 * @author kstaderm
 */
public class ListTableToExcel implements ExportDataI {
     ...
     */
    public ListTableToExcel( String tableName, ListTableModel tableModel ) {
        this.tableName = tableName;
        setData( tableModel );
    }


    private void setData( ListTableModel tableModel ) {
        List<List<Object>> dataList = tableModel.getDataList();
