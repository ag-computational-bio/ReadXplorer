...
public class SeqPairPopup extends JPopupMenu {
    ...
    private void initDataAndComponents() {
        ...
        TitledBorder title = BorderFactory.createTitledBorder(NbBundle.getMessage(SeqPairPopup.class, "SeqPairDetails"));
        ...
        List<PersistantSequencePair> seqPairs = seqPairData.getSequencePairs();
