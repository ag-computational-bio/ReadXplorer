...
public interface Movie {
   ...
   * @param List<Point2D[]> - A list of Point2D arrays describing the 2D coordinates of the structure.
   * @param List<PairTable> - A list of Naview Pair table objects
   * @param String - The title of current set of structurs, visible within the graphics context.
   * @param String -
   ...
   *  @param int - number of interpolation between two structures
   *  @param int - interpolation step
   *  @param boolean - resize the structure to a maximum that it fit inside the image dimensions
