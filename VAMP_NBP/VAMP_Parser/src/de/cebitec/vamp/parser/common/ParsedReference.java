...
public class ParsedReference {
    ...
    /**
     * Adds sub features to their parent features. Should only be called after all
     * regular features have been imported. If a parent feature cannot cannot be found 
     * the sub feature becomes a regular feature. So they all should contain as much 
     * information as a regular feature, if possible.
     * @param sub features the sub features to add to their parent feature for this genome.
     */
