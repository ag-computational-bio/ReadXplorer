...
//    public List<Snp> findSNPs(int percentageThreshold, int absThreshold) {
//        
//        Logger.getLogger(this.getClass().getName()).log(Level.INFO,"start getting snps1");
...
//                }
//            }
//            Logger.getLogger(this.getClass().getName()).log(Level.INFO,"hier");
//        } catch (SQLException ex) {
//            Logger.getLogger(TrackConnector.class.getName()).log(Level.SEVERE, null, ex);
//        }
...
//    }
    ...
    public void schreiben(ArrayList<Snp> snps) {
        Logger.getLogger(this.getClass().getName()).log(Level.INFO,"schreiben1");
        // File anlegen
        file = new File("/homes/jhess/Bachelor/ausgabe5.txt");
        try {
