 ...
 * @author -Rolf Hilker-
 */
public class SamBamSnpDetection implements Observable {
...
//        readLengthDistribution.setType(Properties.READ_LENGTH_DISTRIBUTION);
    ...
    public ParsedTrack createPosTable(File file, String refSeqWhole, String refName) {
        
        long startTime = System.currentTimeMillis();
        String fileName = file.getName();
        TrackJob trackJob = new TrackJob(0, false, null, "", null, null, true, null);
...
//        String shortReadName;
        ...
        try (SAMFileReader sam = new SAMFileReader(file)) {
...
//                        statsContainer.increaseValue(StatsContainer.NO_COMMON_MAPPINGS, 1);
                        ...
                        if (start > nextBatch) { //e.g. 300.001
                            result = new ParsedTrack(trackJob, null, coverageContainer);
                            result.setBatchPos(stop);
...
//                            this.notifyObservers(NbBundle.getMessage(SamBamSnpDetection.class,
...
//                    }
                ...
                if ((lineno % 500000) == 0)  {//output process info only on every XX line
                    ...
                    System.out.println(lineno + " mappings processed ...");
                }
            }
...
//            }
        ...
        result = new ParsedTrack(trackJob, new ParsedMappingContainer(), coverageContainer);
...
//        result.setStatsContainer(statsContainer);
        result.setBatchPos(nextBatch);
        this.notifyObservers(result);
        this.coverageContainer = new CoverageContainer();
//        readNameSet.clear();
        
//        long finish = System.currentTimeMillis();
//        String msg = NbBundle.getMessage(SamBamSnpDetection.class, "PosTableCreator.Finished", file.getName());
