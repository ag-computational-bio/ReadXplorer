...
/**
 * A lookup, that represents a project. Within a project data can be put into it and removed from it.
 * When a selected project changes, the lookup for the new project replaces the old one.
 * The project lookup is associated to the global lookup through a custom implementation of
...
public class ProjectLookup extends AbstractLookup implements Lookup.Provider {
    ...
    /**
     * TopComponents that implement Provider share their ProjectLookup with the global lookup.
     */
