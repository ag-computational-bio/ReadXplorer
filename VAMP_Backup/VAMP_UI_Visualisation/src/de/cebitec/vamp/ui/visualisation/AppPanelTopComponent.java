...
public final class AppPanelTopComponent extends TopComponent implements ApplicationFrameI,ProjectLookup.Provider{
...
//        setIcon(ImageUtilities.loadImage(ICON_PATH, true));
        projectLookup = new ProjectLookup(content);
        associateLookup(projectLookup);
    }
