...
public class PersistentTrack {
     ...
     * @param path          path of the track, if it is a direct file access
     *                      track
     * @param description
     ...
     * @param readPairId
     */
    public PersistentTrack( int id, String path, String description, Timestamp date, int refGenID, int activeChromId, int readPairId ) {
        this.id = id;
     ...
     * @param readPairId
     */
    public PersistentTrack( int id, String path, String description, Timestamp date, int refGenID, int readPairId ) {
    ...
    public boolean equals( Object o ) {
        ...
        if( o instanceof PersistentTrack ) {
            PersistentTrack otrack = (PersistentTrack) o;
            return (otrack.getDescription().equals( this.description )
    ...
    /**
     * Generates a list of track names from a collection of persistent tracks.
     * <p>
     * @param tracks the tracks whose descriptions need to be returned in a list
     * <p>
     * @return The list of track names from the given collection of persistent
     *         tracks.
     */
    public static List<String> generateTrackDescriptionList( Collection<PersistentTrack> tracks ) {
