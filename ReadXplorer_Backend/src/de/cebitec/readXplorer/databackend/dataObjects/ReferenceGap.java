 ...
 */
public class ReferenceGap extends BasicDiff implements Comparable<ReferenceGap>,
                                                       Serializable {
     ...
     * Creates a new comparable gap in the reference sequence.
     * <p>
     * @param position        the absolute reference position at which the gap
     *                        is added
     * @param base            the base to add
     * @param order           the index (beginning with 0) of the reference gap
     *                        at the
     *                        given position
