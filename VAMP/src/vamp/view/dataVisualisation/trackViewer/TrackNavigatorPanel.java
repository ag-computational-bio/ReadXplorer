...
public class TrackNavigatorPanel extends AbstractInfoPanel {
    ...
    private void initComponents() {
        ...
        trackStatisticsPanel1 = new vamp.view.dataVisualisation.trackViewer.TrackStatisticsPanel(trackCon);
        trackOptionsPanel2 = new vamp.view.dataVisualisation.trackViewer.TrackOptionsPanel(basePanelFactory, track, boundsManager);
    ...
    private vamp.view.dataVisualisation.trackViewer.TrackOptionsPanel trackOptionsPanel2;
    private vamp.view.dataVisualisation.trackViewer.TrackStatisticsPanel trackStatisticsPanel1;
