...
public class ColorProperties {
    ...
    //seq logo specific colors for base background
    public static Color BACKGROUND_A = new Color(22, 0, 255, 100);
    public static Color BACKGROUND_C = new Color(176, 4, 0, 100);
    public static Color BACKGROUND_G = new Color(37, 201, 213, 100);
    public static Color BACKGROUND_T = new Color(247, 229, 63, 100);
    public static Color BACKGROUND_N = new Color(155, 42, 170, 100);
    public static Color BACKGROUND_READGAP = new Color(178, 178, 178, 100);
    public static Color BACKGROUND_BASE_UNDEF = UNDEF_FEATURE;
