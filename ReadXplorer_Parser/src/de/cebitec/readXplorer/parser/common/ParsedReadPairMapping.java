...
public class ParsedReadPairMapping {
     ...
     * Parsed mapping references have to be passed, because the mapping id is
     * not set yet.
     * It will be set when storing the data to the db.
     * <p>
     * @param seqPairID  interim id of the sequence pair
     * @param type       type of the sequence pair (0-5 = perfect, distance too
     *                   small, distance too large, orientation wrong
     ...
     *         sequence pair
     *         along the genome. Each of them is stored in another
